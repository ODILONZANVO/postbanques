  ...
  return (
    <div className="caracteristique-container">
      <p className="intro">
        ...
        <p className='mt-2'>Vous souhaitez créer une nouvelle chambre d’enfant ?  Ouvrir votre cuisine à votre espace de vie ? Aménager votre terrasse pour profiter des belles journées ? La Banque Postale vous propose le financement adapté à votre besoin  : le Prêt personnel Travaux.</p>
      </p>
      <div>
        <div className='flex between items-center '>
          ...
          <p className='bg-green-200 p-5 rounded-md mt-5'><img src="logo/image.png" alt="logo de traveaux" /></p>
        </div>
      </div>
      <p className="example">
        <i>
